                        ...
                        if($request->hasFile('image')) {
                            ...
                            if(isset($photo) && !empty($photo) && $photo->isValid()) {
                                ...
                                if($validator->passes()) {
                                    ...
                                    $file_path = (config('constants.notification_img_path').$file_name);
                                    $file_path1 = (config('constants.notification_img_path1').$file_name);
                                    $file_path2 = (config('constants.notification_img_path2').$file_name);
