$(window).on("load", function() {
    ...
    var e = new Chartist.Line(
            ".series-overrides-chart",
            {
                labels: ["1", "2", "3", "4", "5", "6", "7", "8"],
                series: [
                    { name: "series-1", data: [5, 2, -4, 2, 0, -2, 5, -3] },
                    { name: "series-2", data: [4, 3, 5, 3, 1, 3, 6, 4] },
                    { name: "series-3", data: [2, 4, 3, 1, 4, 5, 3, 2] }
                ]
            },
            {
                fullWidth: !0,
    ...
    new Chartist.Bar(".bi-polar-bar-chart", a, t),
        new Chartist.Bar(
            ".stacked-bar-chart",
            {
                labels: ["Q1", "Q2", "Q3", "Q4"],
    ...
    new Chartist.Pie(".pie-chart", a, {
        labelInterpolationFnc: function(e) {
            return Math.round((e / a.series.reduce(n)) * 100) + "%";
        }
    });
    (a = { labels: ["Bananas", "Apples", "Grapes"], series: [20, 15, 40] }),
        (t = {
            labelInterpolationFnc: function(e) {
                return e[0];
            }
        });
    new Chartist.Pie(".pie-custome-label-chart", a, t, [
        [
        ...
        [
            ...
            { labelOffset: 100, chartPadding: 50 }
        ]
    ]),
        (e = new Chartist.Pie(
            ".animation-chart",
            ...
            if ("slice" === e.type) {
                ...
                0 !== e.index &&
                    (t["stroke-dashoffset"].begin =
                        "anim" + (e.index - 1) + ".end"),
                    e.element.attr({ "stroke-dashoffset": -a + "px" }),
