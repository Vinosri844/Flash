...
@section('content')
    ...
    <h5><b>Standerd Pincode Update</b></h5> <br />
            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form method="post" name="payments_form" id="payments_form" action="{{ route('sdpincodeedit_submit',$sdpincode->pincode_id) }}" enctype= multipart/form-data>
                                {{ csrf_field() }}
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-label-group">
                                                <input type="text" id="pincode" class="form-control" placeholder="pincode"
                                                       name="pincode" value="{{$sdpincode->pincode}}">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group" style="display: flex">
                                                ...
                                                <?php $check = $sdpincode->isactive == 1 ? 'checked' : ''; ?>
