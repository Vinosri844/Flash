...
@section('content')
    ...
    <h5><b>SMS Template Update</b></h5> <br />
            ...
            <div class="col-md-12 col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form method="post" name="payments_form" id="payments_form" action="{{ route('smstemplateedit_submit',$smstemplate->sms_template_id) }}" enctype= multipart/form-data>
                                {{ csrf_field() }}
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-label-group">
                                                <input type="text" id="sms_template_name" class="form-control" placeholder="SMS Template Name"
                                                       name="sms_template_name" value="{{$smstemplate->sms_template_name}}">
                                        ...
                                        <div class="col-6">
                                            <div class="form-label-group">
                                                <input type="text" id="template_description" class="form-control" placeholder="SMS Template Description"
                                                       name="template_description" value="{{$smstemplate->sms_template_data}}">
