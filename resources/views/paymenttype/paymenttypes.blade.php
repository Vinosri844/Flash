                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="custom-control custom-switch custom-switch-glow custom-control-inline">
                                                        <input type="checkbox" class="custom-control-input" {{$payment->isactive == 1 ? 'checked' : ''}} id="customSwitchGlow{{$k}}">
                                                ...
                                                <td>
                                                    <div  style="display:inline-flex">
                                                        <button class="btn-outline-info mr-1" ><a href="{{ route('paymenttype_edit',$payment->id) }}"><i class="bx bxs-edit-alt" data-icon="warning-alt"></i></a></button>
                                                        {{-- <button clas
s="btn-outline-danger"><i class="bx bx-trash-alt"></i></button> --}}
                                                        <button  onclick = "return confirm('Are you sure wanted to delete this {{$payment->payment_name}} ?')" style="display: inline" class="btn-outline-danger">
                                                            <a href="{{route('paymenttype_delete',['id'=>$payment->id])}}"><i style="color: red" class="bx bx-trash-alt"></i></a>
                                                        </button>
