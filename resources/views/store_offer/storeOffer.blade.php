            ...
            <div class="card-header">
                <p class="card-text">  
                        ...
                        <div class="col-sm-8">  <h4 class="card-title">List</h4>
                            ...
                            <div class="col-sm-4">
                            <a href="{{ route('store-offer.create') }}" class="btn btn-primary float-right" class="btn btn-primary">Create Store Offer</a>
                            </div>
                    ...
                    <div class="card-body card-dashboard">
                        ...
                        <div class="table-responsive">
                            <table class="table zero-configuration " style="width:100%;">
                                ...
                                <tbody>
                                        @if(isset($store_offers) && !empty($store_offers))
                                            @foreach ($store_offers as $k => $item)
                                            <tr>
                                            ...
                                            <td class="text-center">{{ date('d M, Y', strtotime($item->start_date)) }} <span class="text-primary"> TO</span> <br> {{ date('d M, Y', strtotime($item->end_date)) }}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('store-offer.edit', $item->store_offer_id) }}" method="get">
                                                        <button class="btn-outline-info mr-1"><i class="bx bxs-edit-alt" data-icon="warning-alt"></i></button>
                                                    </form>
                                                   
                                                       
                                                <form action="{{ route('store-offer.destroy', $item->store_offer_id) }}" method="post" 
